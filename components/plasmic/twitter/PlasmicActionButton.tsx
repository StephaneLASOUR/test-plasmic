...
import sty from "./PlasmicActionButton.module.css"; // plasmic-import: Kw25oLZaMx3/css
...
function PlasmicActionButton__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div
        className={classNames(projectcss.all, sty.freeBox___33HGc, {
          [sty.freeBoxoptions_large___33HGcUh3C]: hasVariant(
            variants,
            "options",
            "large"
          ),
          [sty.freeBoxoptions_medium___33HGc2710]: hasVariant(
            variants,
            "options",
            "medium"
          )
      ...
      >
        {(triggers.hover_root ? true : true) ? (
          <div
            className={classNames(projectcss.all, sty.freeBox__wEhyh, {
              [sty.freeBoxoptions_labeled__wEhyhIIqE]: hasVariant(
                variants,
                "options",
                "labeled"
              ),
              [sty.freeBoxoptions_medium__wEhyh2710]: hasVariant(
                variants,
                "options",
                "medium"
              )
        ...
        {p.renderPlasmicSlot({
          defaultContents: (
            <ReplyIcon
              className={classNames(projectcss.all, sty.svg__tD4Fm)}
              role={"img"}
            />
          ),
